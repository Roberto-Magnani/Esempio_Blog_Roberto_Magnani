        ...
        <div class="col-12 col-md-4 bg-dark myclass">
            ...
            <form class="bg-dark rounded-4 p-3" method="POST" action="{{route('send_email')}}">
                ...
                <div class="mb-3 text-white">
                    ...
                    <div id="emailHelp" class="form-text text-red">We'll never share your email with anyone else.</div>
                </div>
                <div class="mb-3 text-white">
                ...
                <button type="submit" class="btn btn-outline-danger">Invia</button>
            </form>
        </div>
    </div>
</section>